    ...
    if (strokes === 0) {
        return (
            <Box>
                ...
                <input value={''} onChange={handleFormChange} type='text' className="stroke-input" pattern="[1-9]" />
        ...
        return (
            <Box>
                {isMobile && <AddIcon fontSize='small' />}
                <input value={strokes} onChange={handleFormChange} type='text' className="stroke-input" pattern="[1-9]" />
                {isMobile &&  <RemoveIcon fontSize='small' />}
            </Box>
        )
    }
